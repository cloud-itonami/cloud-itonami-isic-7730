# Operator Quickstart — Renting and leasing of other machinery, equipment and tangible goods n.e.c.

Shortest path from clone to a verified local dry-run for **ISIC 7730** (`cloud-itonami-isic-7730`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-7730.git
cd cloud-itonami-isic-7730
```
...
- Blueprint governor key: `equipment-rental-governor`
- Likely source path: `equiprentalops.governor.cljc`
